        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?=base_url(); ?>camp-manager">
                        <!-- Logo icon -->
                        <b>Camp Manager</b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-paint-brush"></i><span class="hide-menu">Supplies <span class="label label-rouded label-primary pull-right">1</span></span></a>
                              <ul aria-expanded="false" class="collapse">
                                  <li><a href="<?=base_url();?>camp-manager/request"><i class="fa fa-plus"></i> Request Item </a></li>
                              </ul>
                          </li>
                         <li>
